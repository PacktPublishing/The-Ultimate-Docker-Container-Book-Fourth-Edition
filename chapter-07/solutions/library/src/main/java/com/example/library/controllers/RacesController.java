...
public class RacesController {
    ...
    public Iterable<Race> getBySpecies(@PathVariable("speciesId") Long speciesId) {
    ...
    @PutMapping("/races/{id}")
    public ResponseEntity<Race> update(@PathVariable("id") Long id, @RequestBody Race updatedRace) {
        var race = repository.findById(id);
        if (!race.isPresent())
