...
public class SpeciesController {
    ...
    public ResponseEntity<Species> getById(@PathVariable("id") Long id) {
    ...
    public ResponseEntity<Species> update(@PathVariable("id") Long id, @RequestBody Species updatedSpecies) {
